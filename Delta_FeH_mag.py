...
D_spot, D_Age_Hb = np.loadtxt('/home/ant/Research/fp_proj/hwgn/data/Disc_spec.dat',unpack=True,usecols=(0,2),delimiter=',')
B_spot, B_Age_Hb = np.loadtxt('/home/ant/Research/fp_proj/hwgn/data/Bulge_spec.dat',unpack=True,usecols=(0,2),delimiter=',')
D_spot_err, D_age_plus_err, D_age_minus_err = np.loadtxt('/home/ant/Research/fp_proj/hwgn/data/Disc_spec.dat_err',unpack=True,usecols=(0,3,4),delimiter=',')
B_spot_err, B_age_plus_err, B_age_minus_err = np.loadtxt('/home/ant/Research/fp_proj/hwgn/data/Bulge_spec.dat_err',unpack=True,usecols=(0,3,4),delimiter=',')
...
subplot(3,3,1)
scatter(low_vdisp,low_re,vmin=-.25,vmax=.12,c=low_Disc_Age_Hb,cmap='bwr')
...
subplot(3,3,2)
scatter(mid_vdisp,mid_re,vmin=-.25,vmax=.12,c=mid_Disc_Age_Hb,cmap='bwr')
xlim(1.8,2.5); ylim(-.2,1.0)
title('mid-SB',fontsize=16)
grid(True)

subplot(3,3,3)
scatter(high_vdisp,high_re,vmin=-.25,vmax=.12,c=high_Disc_Age_Hb,cmap='bwr')
xlim(1.8,2.5); ylim(-.2,1.0)
...
subplot(3,3,4)
scatter(low_vdisp,low_re,vmin=-.25,vmax=.12,c=low_Bulge_Age_Hb,cmap='bwr')
xlim(1.8,2.5); ylim(-.2,1.0)
ylabel('Bulge [Fe/H]\n\nlog $R_e$ [kpc]',fontsize=16)
grid(True)

subplot(3,3,5)
scatter(mid_vdisp,mid_re,vmin=-.25,vmax=.12,c=mid_Bulge_Age_Hb,cmap='bwr')
xlim(1.8,2.5); ylim(-.2,1.0)
grid(True)

subplot(3,3,6)
scatter(high_vdisp,high_re,vmin=-.25,vmax=.12,c=high_Bulge_Age_Hb,cmap='bwr')
colorbar()
xlim(1.8,2.5); ylim(-.2,1.0)
grid(True)

subplot(3,3,7)
scatter(low_vdisp,low_re,vmin=-.2,vmax=.2,c=low_dAge_Hb,cmap='bwr')
xlim(1.8,2.5); ylim(-.2,1.0)
ylabel('[Fe/H]$_{Bulge}$ - [Fe/H]$_{Disc}$ \n\n log $R_e$ [kpc]',fontsize=16);xlabel('log $\sigma$ [km/s]',fontsize=16)
grid(True)

subplot(3,3,8)
scatter(mid_vdisp,mid_re,vmin=-.2,vmax=.2,c=mid_dAge_Hb,cmap='bwr')
xlim(1.8,2.5); ylim(-.2,1.0)
xlabel('log $\sigma$ [km/s]',fontsize=16)
grid(True)

subplot(3,3,9)
scatter(high_vdisp,high_re,vmin=-.2,vmax=.2,c=high_dAge_Hb,cmap='bwr')
colorbar()
xlim(1.8,2.5); ylim(-.2,1.0)
xlabel('log $\sigma$ [km/s]',fontsize=16)
grid(True)
